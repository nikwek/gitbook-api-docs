...
```
GET https://api.appoptics.com/v1/dashboards
```
...
curl \
  ...
  -u $APPOPTICS_TOKEN: \
  -X GET \
  'https://api.appoptics.com/v1/dashboards?name=ops'
```
...
```
GET https://api.appoptics.com/v1/dashboards/:id
```
...
curl \
  ...
  -u $APPOPTICS_TOKEN: \
  -X GET \
  'https://api.appoptics.com/v1/dashboards/129'
```
...
```
POST https://api.appoptics.com/v1/dashboards
```
...
curl \
  ...
  -X POST \
  'https://api.appoptics.com/v1/dashboards'
```
...
```
PUT https://api.appoptics.com/v1/dashboards/:id
```
...
curl \
  ...
  -X PUT \
  'https://api.appoptics.com/v1/dashboards/:id'
```
...
```
DELETE https://api.appoptics.com/v1/dashboards/:id
```
...
curl \
  ...
  -u $APPOPTICS_TOKEN: \
  -X DELETE \
  'https://api.appoptics.com/v1/dashboards/145'
```
