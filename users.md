...
<aside class="notice">Note: The Users API will to be enabled before you can utilize it. Please <a href="mailto:support@appoptics.com">contact the Librato support team</a> for access.</aside>
...
```
GET https://api.appoptics.com/v1/users
```
...
curl \
  ...
  -u $APPOPTICS_TOKEN: \
  -X GET \
  'https://api.appoptics.com/v1/users'
```
...
curl \
  ...
  -u $APPOPTICS_TOKEN: \
  -X GET \
  'https://api.appoptics.com/v1/users?reference=67523'
```
...
```
GET https://api.appoptics.com/v1/users/:id
```
...
curl \
  ...
  -u $APPOPTICS_TOKEN: \
  -X GET \
  'https://api.appoptics.com/v1/users/123'
```
...
```
POST https://api.appoptics.com/v1/users
```
...
```
PUT https://api.appoptics.com/v1/users/:id
```
...
curl \
  ...
  -d 'password_reset=1' \
  -X PUT \
  'https://api.appoptics.com/v1/users/156'
```
...
```
DELETE https://api.appoptics.com/v1/users/:id
```
...
curl \
  ...
  -u $APPOPTICS_TOKEN: \
  -X DELETE \
  'https://api.appoptics.com/v1/users/672'
```
